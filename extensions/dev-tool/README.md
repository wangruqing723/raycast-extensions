...
- **Unicode**: Unicode 编码转换，支持多种格式展示（十六进制、JavaScript、Unicode 标准、十进制）
...
2. 输入下列任一格式的内容：
   - **普通文本**：`你好`、`Hello`
   - **JavaScript 格式**：`你好`
   - **Unicode 标准格式**：`U+4F60 U+597D`
   - **十进制码点**：`20320 22909`
   - **十六进制码点**：`4F60 597D`
3. 系统自动检测输入格式并转换
4. 结果实时展示所有格式转换（十六进制、JavaScript、Unicode 标准、十进制）
